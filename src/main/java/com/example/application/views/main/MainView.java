 ...
 */
@PWA(name = "Stock Manager (Andres)", shortName = "Stock Manager (Andres)", enableInstallPrompt = false)
@Theme(themeFolder = "stockmanagerandres")
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "Stock Manager (Andres) logo"));
        logoLayout.add(new H1("Stock Manager (Andres)"));
